 ...
 */
public class AppendSemicolon implements ICommand, IWritable {
    private FormatterContext formatterContext;

    /**
     * AppendSemicolon constructor with one parameter
     *
     * @param formatterContext - formatter context for modifying
     */
    public AppendSemicolon(final FormatterContext formatterContext) {
