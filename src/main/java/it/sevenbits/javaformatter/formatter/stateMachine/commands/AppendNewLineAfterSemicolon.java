 ...
 */
public class AppendNewLineAfterSemicolon implements ICommand, IWritable {
    private FormatterContext formatterContext;
    private ITabulator tabulator;

    /**
     * AppendNewLineAfterSemicolon constructor with one parameter
     *
     * @param formatterContext - formatter context for modifying
     */
    public AppendNewLineAfterSemicolon(final FormatterContext formatterContext) {
